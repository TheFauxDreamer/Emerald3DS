...
It is also the precedent for the next such view: an EXTRA page costs one `PAGE_COUNT` bump and three dispatch lines, so a view that does not earn a tab can land there while the launcher is still being built.
