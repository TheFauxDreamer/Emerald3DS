...
#if RP2350
    // common_data is a NOLOAD region on RP2350 (memmap_emerald.ld), so the
    // static initializers on gFlash and the ProgramFlash*/EraseFlash*
    // function pointers (agb_flash.c) are discarded -- they read as NULL at
