...
#if !RP2350
    // RP2350 has no GBA LCD: REG_ADDR_VCOUNT is plain SRAM and never reaches
    // 159, so these sync-to-vblank spins would hang forever. The audio timer is
    // unused here (the mixer is driven once per frame from VBlankIntr).
